RailsAdmin.config do |config|
  ...
  config.model Order do
    ...
    include_fields :id, :type_of_shipping, :name, :phone, :email, :subscribe, :city, :street, :building, :flat, :date_of_shipping, :fast_or_not, :type_of_pay, :rest, :comment, :pick_up_from, :date_of_picking, :time_of_picking
  end
